...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		...
		<form:form method="POST" modelAttribute="user" class="form-horizontal" action="${addUserUrl}">
			<fieldset class="content-group">
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<form:input type="text" path="id" id="id" name="id" class="form-control" required="required" placeholder="Please enter staff ID No" />
						<div class="has-error">
